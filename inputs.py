...
def display_inputs():
    ...
    st.sidebar.number_input(
      ...
      st.sidebar.number_input(
        "Gold tails Grade", key="gold_tails_grade", min_value=0.0, step=0.01
    )
    ...
    st.sidebar.number_input("Tailings Throughput", key="Tailings throughput", min_value=0.0, step=0.01)
    st.sidebar.subheader("", divider="blue")
